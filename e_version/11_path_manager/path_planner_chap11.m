function out = path_planner_chap11(in, atp)
  ...
  if 1
    wpp = [...
%             0,   0,   -100, -9999, atp.Va0;...
%             1200, 0,   -100, -9999, atp.Va0;...
%             0,   1200, -100, -9999, atp.Va0;...
%             1200, 1200, -100, -9999, atp.Va0;...
            0,   0,   -200, -9999, atp.Va0;...
            1000, 0,   -200, -9999, atp.Va0;...
            0,   1000, -200, -9999, atp.Va0;...
%             1000, 1000, -200, -9999, atp.Va0;...
%             0,   0,   -200, -9999, atp.Va0;...
           ];
  else  % Dubins
    wpp = [...
  ...
  for i=6:atp.size_waypoint_array
      wpp = [...
          wpp;...
